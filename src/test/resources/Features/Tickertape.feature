Feature: Tickertape Site Automation
  ...
  @TT_TestCase1 @TT_Regression @Smoke @E2ETestRun
  ...
  @TT_TestCase2 @TT_Regression @Smoke @E2ETestRun
  ...
  @TT_TestCase3 @TT_Regression @E2ETestRun
  ...
  @TT_TestCase6 @TT_Regression @E2ETestRun
  ...
  @TT_TestCase7 @TT_Regression @E2ETestRun
  ...
  @TT_TestCase8 @TT_Regression @E2ETestRun
  ...
  @TT_TestCase9 @TT_Regression @E2ETestRun
